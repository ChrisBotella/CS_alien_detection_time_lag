...
- <10 records without google info
...
lags <- filter(lags,!is.na(google_sum))
...
modelbas <- lmer(timeLag~  google_country+ scopus + NumAliensOff_Country +habitat2+ LifeForm3 + obsInNeigborCountryBefore+NumRecCS_Species+NumRecCS_CountryLifeform + priority+(1|Region),data=lags_eu )
summary(modelbas)
